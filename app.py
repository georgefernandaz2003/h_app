...
if not st.session_state.authenticated:
    ...
    with login_tab1:
        login_email = st.text_input("Enter Your Email ID", value="dr.smith@hospital.com", placeholder="e.g. dr.smith@hospital.com", key="login_email_input")
        login_id = st.text_input("Enter Your User ID", value="D001", placeholder="e.g. D001, PA001, U001", key="login_id_input")
        login_role = st.text_input("Enter Your Role", value="doctor", placeholder="e.g. doctor, patient, admin, pharmacist, labtechnician", key="login_role_input")
