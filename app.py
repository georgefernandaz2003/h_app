...
endpoint_name = "mas-51bfb345-endpoint"

db_host = (default_client.config.host if default_client and default_client.config.host else os.environ.get("DATABRICKS_HOST", "https://dbc-eb4ee151-207c.cloud.databricks.com/"))
db_token = (
    get_request_header("x-forwarded-access-token") if get_request_header("x-forwarded-access-token")
